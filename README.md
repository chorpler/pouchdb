...
--------------
- Trying lerna again.
- Based on: [Ionic and Lerna and Rollup, oh my!](https://ionicframework.com/blog/ionic-and-lerna-and-rollup-oh-my/)
- Sample: [Ionic and Lerna React Monorepo](https://github.com/ionic-enterprise/lerna-cap-react-appflow)
